...
//
///**/
//public class ProjectsWorkAdapter extends ArrayAdapter<GIProjectInfo>
//{
//	private final Context m_context;
//	public TextView m_project_decsiption;
//	public TextView m_project_name;
//	public ListType m_Type;
//
...
//    {
//		final GIProjectInfo item = GIServer.Instance().getAt(m_Type, position);
...
//				}
//				String project_packages_str = (m_context.getResources().getString(item.getStateStringId())) + ": ";
//				for(GIPropertiesPackage pack : item.getProjectPackages())
//				{
//					project_packages_str += pack.m_name + "; ";
//				}
//				viewHolder.m_TextViewPackages.setVisibility(View.VISIBLE);
//				viewHolder.m_TextViewPackages.setText(project_packages_str);
...
//				viewHolder.m_TextViewProgress.setVisibility(View.GONE);
//			}
//			viewHolder.m_ImageViewStatus.setImageResource(item.getStatusImageId());
//			viewHolder.m_TextViewName.setText(item.m_name);
//			viewHolder.m_TextViewPath.setText(item.m_file);
//		}
//		return v;
//    }
//	public ProjectsWorkAdapter (Context context, int resource, int textViewResourceId)
//    {
